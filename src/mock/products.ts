...
const PRODUCT_IMAGES: Record<string, string> = {
  // 果酒产品图（yixia-wine目录）
  prod_pomegranate_new: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/01-liu-hong-xin-shi.webp',
  prod_grape_wine: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/02-pu-xiang-an-du.webp',
  prod_peach_new: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/03-tao-xin-an-dong.webp',
  prod_apple_wine: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/04-qing-ping-wei-zui.webp',
  prod_guava_wine: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/05-fen-le-wu-qiong.webp',
  prod_red_wine: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/06-hong-pu-tao-guo-jiu.webp',
  // 原果汁产品图（yixia-juice目录）
  juice_pear: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/01-xian-li.webp',
  juice_peach: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/02-xian-tao.webp',
  juice_red_grape: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/03-hong-pu-tao.webp',
  juice_white_grape: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/04-bai-pu-tao.webp',
  // 礼盒产品图（暂用果汁图占位）
  ...
  // 毕业派对套餐图
  pkg_graduation_party: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/01-banner.webp',
}
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 16.8,
    originalPrice: 28.8,
    image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-old/01-you-zi-jiu.webp',
    images: ['https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-old/01-you-zi-jiu.webp'],
  ...
  },
  {
    ...
    price: 16.8,
    originalPrice: 28.8,
    image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-old/02-yi-meng-shan-zha-jiu.webp',
    images: ['https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-old/02-yi-meng-shan-zha-jiu.webp'],
  ...
  },
  {
    ...
    price: 16.8,
    originalPrice: 28.8,
    image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-old/03-shan-zha-wu-long-jiu.webp',
    images: ['https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-old/03-shan-zha-wu-long-jiu.webp'],
  ...
  // ============ 礼盒套装（邑夏品牌，2款）============
  {
    ...
    images: [PRODUCT_IMAGES.gift_juice_box, 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/01-xian-li.webp', 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/02-xian-tao.webp', 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/03-hong-pu-tao.webp', 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-juice/04-bai-pu-tao.webp'],
    tags: ['礼盒', '果汁套装', '送礼', '家庭装'],
    category: 'gift_box',
    alcohol: '0%vol',
    capacity: '300ml×8',
  ...
  },
  {
    ...
    images: [PRODUCT_IMAGES.gift_wine_box, 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/01-liu-hong-xin-shi.webp', 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/02-pu-xiang-an-du.webp', 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/03-tao-xin-an-dong.webp', 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/04-qing-ping-wei-zui.webp'],
    tags: ['礼盒', '果酒套装', '送礼', '珍藏'],
    category: 'gift_box',
    alcohol: '7%vol',
    capacity: '500ml×4',
  ...
  // ============ 毕业套餐 ============
  {
    ...
    images: [
      'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/01-banner.webp',
      'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/02-scene1.webp',
      'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/03-scene2.webp',
      'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/04-scene3.webp',
      'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/05-scene4.webp',
      'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-party/06-detail.webp',
    ],
    tags: ['套餐', '毕业季', '派对', '拼团'],
    category: 'gift_box',
    alcohol: '7%vol',
...
export const MOCK_FLASH_SALE: FlashSaleProduct[] = [
  {
    ...
    image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/01-liu-hong-xin-shi.webp',
    spriteAlias: ''
  },
  {
    id: 'prod_peach_new',
    ...
    pintuanCount: 96,
    endTime: '2026-12-31 18:00:00',
    image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@1fc4e93/src/assets/images/products/yixia-wine/03-tao-xin-an-dong.webp',
    spriteAlias: ''
  }
]
