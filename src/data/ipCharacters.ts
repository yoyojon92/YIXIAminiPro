...
const XIN_XIN: IPCharacter = {
  ...
  image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@44659b2/src/assets/images/ip/xinxin.jpg',
  emoji: '❤️',
};
...
const GAN_GAN: IPCharacter = {
  ...
  image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@44659b2/src/assets/images/ip/gangan.jpg',
  emoji: '💚',
};
...
const PI_PI: IPCharacter = {
  ...
  image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@44659b2/src/assets/images/ip/pipi.jpg',
  emoji: '💛',
};
...
const FEI_FEI: IPCharacter = {
  ...
  relatedProducts: ['清苹微醉'],
  productIds: ['prod_apple_wine'],
  image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@44659b2/src/assets/images/ip/feifei.jpg',
  emoji: '🤍',
};
...
const SHEN_SHEN: IPCharacter = {
  ...
  relatedProducts: ['榴红心事'],
  productIds: ['prod_pomegranate_new'],
  image: 'https://cdn.jsdelivr.net/gh/yoyojon92/YIXIAminiPro@44659b2/src/assets/images/ip/shenshen.jpg',
  emoji: '💜',
};
